...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-11 items-center justify-start rounded-xl bg-stone-100 p-1 text-stone-500 w-full overflow-x-auto scrollbar-hide touch-pan-x",
