-- PUBLIC RPC: Create Reservation from Widget
-- Allows external websites to create reservations securely without exposing table RLS
-- Date: 2026-01-23
...
-- Grant access to anon (public) role so the website can call it
